    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden pt-24 pb-12 text-brand-text">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-5xl font-normal tracking-tight mb-2 uppercase font-display leading-none">WELCOME <span className="text-brand-accent">BACK</span></h1>
          <p className="text-brand-text-secondary font-medium">Good to see you again, let’s get you back to something great.</p>
        </div>
